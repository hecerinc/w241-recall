...
```{r DID plots, fig.height=10, fig.caption="Difference in differences plots"}
# pos DID plot
...
```{r, fig.cap="Respondent count by age group and treatment"}
...
```{r Attritionplot,  fig.cap = "Plot of Attrition by Age and Treatment"}
...
```{r CompletionTimeHistogram, fig.cap='Completion time distribution for post-treatment memory task', message=F}
