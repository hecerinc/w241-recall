...
pos_did_plot <- did_plotdata_pos %>%
  ...
  labs(x="", y="score (mean)", subtitle = "DID plot: Positive Treatment vs Control") +
  annotate(
    "text",
    x = "post-treatment",
    y = 12.2,
...
neutral_did_plot <- did_plotdata_neutral %>%
  ...
  labs(x="", y="score (mean)", subtitle = "DID plot: Neutral Treatment vs Control") +
  annotate(
    "text",
    x = "post-treatment",
    y = 10.5,
...
neg_did_plot <-did_plotdata_negative %>%
  ...
  labs(x="", y="score (mean)", subtitle = "DID plot: Negative Treatment vs Control") +
  annotate(
    "text",
    x = "post-treatment",
    y = 10,
...
p1 <- ggplot(d, aes(x=gender, fill = age.demographic)) +
  geom_bar(position="stack", show.legend = FALSE) + ggtitle("Gender")
p1 <- p1 + theme(axis.text.x = element_text(angle = 25, hjust = 1))
p2 <- ggplot(d, aes(x=highest.education, fill = age.demographic)) +
  geom_bar(position="stack", show.legend = FALSE) + labs (x = "highest education")  + ggtitle("Highest Education")
p2 <- p2 + theme(axis.text.x = element_text(angle = 30, hjust = 1))
p3 <- ggplot(d, aes(x=english.native, fill = age.demographic)) +
  geom_bar(position="stack") + labs (x = "english native", fill = "age group") + ggtitle("English Native")
